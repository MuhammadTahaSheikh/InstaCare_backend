...
- NEVER invent or list specific doctor names (no "Dr. Ali", numbered lists, etc.) — real verified names are added automatically from our database after your reply.
